...
history_df_combined_mod = pd.DataFrame(history_combined.history)
history_df_combined_mod.to_csv('/home/emmy/Notebooks2/history_combined_mod.csv', index=False)
print("Minimum validation loss: {}".format(history_df_combined_mod['val_loss'].min()))

# Predict CCS values test set
ccs_test["Model_combined_predictions_mod"] = parallel_model.predict([matrix_test, matrix_all_test, matrix_test, matrix_all_test])

ccs_test.to_csv('/home/emmy/Notebooks2/ccs_test_model_combined_mod.csv', index=False)